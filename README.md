...
2 -> Nano GPT-OSS : I built the GPT-OSS architecture from, and instead of 20B model, I built a 588M model. I used the A100 from lightning AI to accomplish this.
